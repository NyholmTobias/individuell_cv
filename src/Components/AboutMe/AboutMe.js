...
const AboutMe = () => {
    ...
    return (
        <div className="col-xl-7 col-l-7 col-md-8 col-sm-8 col-xs-8 float-right">
            <h2>About Me</h2>
            <p>In my life I've been working with everything from beeing a warehouse worker, tire fitter, sound technician, customer service and grapichal purchasing. Through the years i have gathered a broad understanding of different businesses and found out what makes me shine and keeps me motivated. I love to work with projects and to learn new skills while I always try to find ways to optimise my what i do. With this knowlege i have now started to aim towards working with a longtime interest and hobby of mine. Software- and system development.</p>
